-- Run this EXACT snippet in your Supabase SQL Editor

-- 1. Drop ALL conflicting versions of the function
...
-- 2. Create the exact correct function
...
-- 3. Set precise execution permissions
...
-- 4. Force PostgREST to reload its cache so the API recognizes the fix immediately
