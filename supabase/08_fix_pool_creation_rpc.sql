-- ═══════════════════════════════════════════════════════════════════
-- PoolNear — Migration 08: Fix Connection RPC Return Type
-- Fixes "structure of query does not match function result type" by
-- explicitly casting c.status (connection_status ENUM) to TEXT to match
-- the declared RETURNS TABLE definition.
-- ═══════════════════════════════════════════════════════════════════
