-- ====================================================================
-- PoolNear — Migration 21: Join Location Fix
-- Update join_pool_atomic to accept destination, latitude, and longitude
-- ====================================================================
...
BEGIN
  ...
  INSERT INTO public.pool_members (
    ...
    COALESCE(p_destination, v_pool_record.destination)
